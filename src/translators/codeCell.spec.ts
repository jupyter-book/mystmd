import { VersionId, KINDS, TARGET, CodeFormatTypes } from '../blocks/index';
import { Code } from '../blocks/code';
import { toJupyter, fromJupyter } from './codeCell';
import { CodeCell, CellOutput, CELL_TYPE } from './types';

describe('Code Block Translators', () => {
  let iooxaId: VersionId;
  let iooxaCodeBlock: Code;
