...
export function getNodesAndMarks(styles?: Styles) {
  const nodes: NodeSerializer = {
    ...
    figure(state, node) {
      ...
      // TODO: localize this ID; we will need an options structure similar to https://github.com/curvenote/curvenote/blob/main/apps/cli/src/export/utils/localizationOptions.ts
