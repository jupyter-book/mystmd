 ...
 * Single TOC entry
 */
export type BasicEntry = (BasicHasSubtrees | BasicShorthandSubtree | {}) & (FileEntry | URLEntry | GlobEntry);


/**
 * Single toctree
 */
export type BasicSubtree = {
  entries: BasicEntry[];
  caption?: string;
  hidden?: boolean;
  maxdepth?: number;
 ...
 * Single TOC entry
 */
export type ArticleEntry = (ArticleHasSubtrees | ArticleShorthandSubtree | {}) & (FileEntry | URLEntry | GlobEntry);


/**
 * Single toctree
 */
export type ArticleSubtree = {
 ...
 * Single TOC entry
 */
export type BookEntry = (BookHasSubtrees | BookShorthandSubtree | {}) & (FileEntry | URLEntry | GlobEntry);


/**
 * Single top-level toctree
 */
export type BookOuterSubtree = {
  chapters: BookEntry[];
  caption?: string;
  hidden?: boolean;
  maxdepth?: number;
