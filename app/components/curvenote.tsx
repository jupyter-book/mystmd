  ...
  return (
    ...
    >
      <g id="icon">
        ...
        <path
          className="st0"
          d="M10.2,218.8h171v171C86.7,389.8,10.2,313.2,10.2,218.8z"
        />
        <path
          className="st0"
          d="M60.3,60.3c32-32.1,75.6-50.2,120.9-50.1v171.1h-171C10.1,135.8,28.1,92.3,60.3,60.3z"
        />
        <path
          className="st0"
          d="M339.7,131.1c-32,32.1-75.6,50.2-120.9,50.1V10.2h171C389.9,55.5,371.8,99,339.7,131.1z"
        />
      </g>
    </svg>
  );
